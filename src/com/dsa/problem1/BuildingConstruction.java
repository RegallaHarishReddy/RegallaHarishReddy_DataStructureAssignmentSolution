...
public class BuildingConstruction {
	...
	public void Syscaper(int Floors) {
		// using Stack for the POP and Pushing of the values
		Stack<Integer> Stack = new Stack<Integer>();
		// using ts for pushing operations
		...
		int i = 0;
		int k = 0;
		// iterating for given number of floors
		for (i = 0; i < Floors; i++) {
			...
			// checking if size is already present
			if (ts.search(n) != -1) {
